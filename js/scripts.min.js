    ...
    n("#experience-timeline").each(function() { 
        ...
        $this.find('.vtimeline-point').each(function() {
            if (icon == 0) {
                ...
                n(this).prepend('<a <div class="vtimeline-pic"><img class = "vtimeline-img-2" src = "/images/etch.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 2) {
                n(this).prepend('<a <div class="vtimeline-pic"><img class = "vtimeline-img-3" src = "/images/glassblow.png"></div></a>'); 
               icon = icon + 1;
            } else if (icon == 3) {
                n(this).prepend('<a <div class="vtimeline-pic"><img class = "vtimeline-img-4" src = "/images/lap.png"></div></a>'); 
                icon = icon + 1;
            } 
        });
    	//$this.find(".vtimeline-point").each(function() { 
