...
! function(n) { 
 ...
 $this.find('.vtimeline-point').each(function() {
            if (icon == 0) {
                n(this).prepend('<a <div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/pulse.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 1) {
                n(this).prepend('<a <div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/damage.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 2) {
                n(this).prepend('<a <div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/immerse.png"></div></a>'); 
               icon = icon + 1;
            } else if (icon == 3) {
                n(this).prepend('<a <div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/feature.png"></div></a>'); 
                icon = icon + 1;
            } 
        });
    	//$this.find(".vtimeline-point").each(function() { 
