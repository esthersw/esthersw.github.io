...
! function(n) { 
    ...
    n("#experience-timeline").each(function() { 
        ...
        $this.find('.vtimeline-point').each(function() {
            if (icon == 0) {
                n(this).prepend('<a href = "https://rise.cs.berkeley.edu/projects/clipper/" target="_blank"><div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/etch.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 1) {
