...
! function(n) { 
 ...
 $this.find('.vtimeline-point').each(function() {
            if (icon == 0) {
                n(this).prepend('<a href = "https://rise.cs.berkeley.edu/projects/clipper/" target="_blank"><div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/etch.jpg"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 1) {
                n(this).prepend('<a href = "https://www.be-spoke.io/" target="_blank"><div class="vtimeline-pic"><img class = "vtimeline-img-2" src = "/images/bond.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 2) {
                n(this).prepend('<a href = "https://swarmlab.berkeley.edu/home" target="_blank"><div class="vtimeline-pic"><img class = "vtimeline-img-3" src = "/images/glassblow.png"></div></a>'); 
               icon = icon + 1;
            } else if (icon == 3) {
                n(this).prepend('<a href = "http://intensivate.com/" target="_blank"><div class="vtimeline-pic"><img class = "vtimeline-img-4" src = "/images/lap.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 4) {
